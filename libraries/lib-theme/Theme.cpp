...
//             .Format( FileName );
   ...
   else
   {
      ...
      {
         ShowMessageBox(
            XO("Otis could not write images to file:\n  %s.")
               .Format( FileName ));
         return false;
      }
   }
