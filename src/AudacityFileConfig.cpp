...
{
   wxDialogWrapper dlg(nullptr, wxID_ANY, XO("Otis Configuration Error"));
   ...
   S.StartVerticalLay(wxEXPAND, 1);
   {
      ...
      S.StartHorizontalLay(wxALIGN_RIGHT, 0);
      {
         S.AddFixedText(
            XO("The following configuration file could not be accessed:\n\n"
               ...
               "If you choose to \"Quit Otis\", your project may be left in an unsaved "
      ...
      S.StartHorizontalLay(wxALIGN_RIGHT, 0);
      {
         ...
         b = S.Id(wxID_CANCEL).AddButton(XXO("&Quit Otis"));
